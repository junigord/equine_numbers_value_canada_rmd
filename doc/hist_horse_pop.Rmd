...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Historical number of horses per province across Canada", out.width = '50%'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Case example: Historical number of horses", out.width = '50%%'}
